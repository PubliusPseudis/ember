...
export const vdfcomputer_compute_proof: (a: number, b: number, c: number, d: bigint, e: any) => [number, number, number];
export const vdfcomputer_verify_proof: (a: number, b: number, c: number, d: number) => [number, number, number];
export const estimate_iterations_for_seconds: (a: number) => bigint;
