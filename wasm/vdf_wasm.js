...
export class VDFComputer {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        VDFComputerFinalization.unregister(this);
        return ptr;
    }
    ...
    constructor() {
        ...
        VDFComputerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    verify_proof(input, proof) {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        _assertClass(proof, VDFProof);
        const ret = wasm.vdfcomputer_verify_proof(this.__wbg_ptr, ptr0, len0, proof.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
...
export class VDFProof {
     ...
     * @param {bigint} iterations
     */
    constructor(y, pi, l, r, iterations) {
        const ptr0 = passStringToWasm0(y, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(pi, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(l, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(r, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.vdfproof_new(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, iterations);
        this.__wbg_ptr = ret >>> 0;
    ...
    get y() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.vdfproof_y(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get pi() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.vdfproof_pi(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get l() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.vdfproof_l(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get r() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.vdfproof_r(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('vdf_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
